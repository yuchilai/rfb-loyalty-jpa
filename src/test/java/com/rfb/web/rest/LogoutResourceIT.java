...
import static com.rfb.web.rest.TestUtil.ID_TOKEN;
import static com.rfb.web.rest.TestUtil.authenticationToken;
...
class LogoutResourceIT {
    ...
    public void before() throws Exception {
        ...
        claims.put("groups", Collections.singletonList(AuthoritiesConstants.RUNNER));
        claims.put("sub", 123);
